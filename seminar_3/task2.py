...
for i in range(len(list_2)):
    mini_list = list_2[i: i + 3]
    if len(mini_list) == 3:
        max_list.append(mini_list)

for j in max_list:
    res_list.append(sum(j))

print(f"На грядке {n} кустов, на которох {list_1} ягод")
print(f"Максимальное количество ягод с трех кустов - {max(res_list)}")
